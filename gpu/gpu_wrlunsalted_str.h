...
static const char gpu_wrlunsalted_str[] =
    ...
    "\n"
    "    /* Byte-swap hash to LE for compact table probe.\n"
    "     * Whirlpool output is 64 bytes (8 x uint64). Compact table uses first 16 bytes.\n"
    "     * Split hash[0] and hash[1] into uint32 pairs. */\n"
