...
static const char metal_keccakunsalted_str[] =
    ...
    "\n"
    "#define KECCAK_METAL_KERNEL(name, rate, rate_words) \\\n"
    "kernel void name( \\\n"
    ...
    "KECCAK_METAL_KERNEL(keccak224_unsalted_batch, 144, 18)\n"
    "KECCAK_METAL_KERNEL(keccak256_unsalted_batch, 136, 17)\n"
    "KECCAK_METAL_KERNEL(keccak384_unsalted_batch, 104, 13)\n"
    "KECCAK_METAL_KERNEL(keccak512_unsalted_batch, 72, 9)\n"
    "\n"
    "/* SHA3 variants (pad byte 0x06, applied by host) */\n"
    "KECCAK_METAL_KERNEL(sha3_224_unsalted_batch, 144, 18)\n"
    "KECCAK_METAL_KERNEL(sha3_256_unsalted_batch, 136, 17)\n"
    "KECCAK_METAL_KERNEL(sha3_384_unsalted_batch, 104, 13)\n"
    "KECCAK_METAL_KERNEL(sha3_512_unsalted_batch, 72, 9)\n"
;
